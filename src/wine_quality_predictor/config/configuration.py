...
from src.wine_quality_predictor.entity.config_entity import (DataIngestionConfig, DataValidationConfig,
...
class ConfigurationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config=ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/satyampant420/Wine-quality-prediction-mlops.mlflow"
